...
public class CustomerDAO {
    ...
    public void addCustomer(Customer customer) {
        String sql = "INSERT INTO customers (accountNumber, name, address, telephone, unitsConsumed, billAmount) VALUES (?, ?, ?, ?, ?, ?)";
    ...
    public boolean updateCustomer(Customer customer) {
        String sql = "UPDATE customers SET name = ?, address = ?, telephone = ?, unitsConsumed = ?, billAmount = ? WHERE accountNumber = ?";
        try (Connection conn = DBConnectionFactory.getConnection();
             PreparedStatement ps = conn.prepareStatement(sql)) {
